...
You can use Outlook add-in events to handle, check, or block user actions when something of interest occurs. Events provide ways to:
...
2. Enable on send add-in functionality.
